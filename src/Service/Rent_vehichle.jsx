  ...
  return (
    ...
    >
      ...
      <div className=" w-[90vw] lg:text-center lg:ml-[1rem] lg:w-[30%] flex flex-col justify-left items-left text-left">
        <div className="sm:w-[100vw] sm:text-[1.7rem] sm:mt-[1.5rem] lg:w-[80%] h-[10vh] lg:mt-[35%] ml-[2rem] lg:ml-0 text-left text-[2.3rem] font-extrabold">
          <p className="sm:w-[100vw]">Rent a vehicle with ease</p>
        </div>
        <p className=" w-[70vw] text-left mt-[0.5rem]  text-[grey] lg:mt-[8%] ml-[2rem] lg:ml-0 lg:w-[75%]">
